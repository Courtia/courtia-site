  ...
  return (
    <main className="site-shell">
      ...
      >
        ...
        <small className="mobile-menu-footer">Courtia, le copilote de votre financement.</small>
      </aside>
      ...
      <section className="how-it-works-section" id="comment-ca-marche" aria-labelledby="comment-ca-marche-title">
        <div className="section-wrap"><div className="how-heading" data-reveal><div><span className="eyebrow eyebrow-light">Comment ça marche ?</span><h2 id="comment-ca-marche-title">Un parcours simple,<br /><em>des réponses concrètes.</em></h2></div><p>En trois étapes, Courtia vous aide à savoir où vous en êtes et quoi faire ensuite.</p></div>
          <div className="how-grid">
            <article className="how-card" data-reveal><div className="how-card-top"><span className="how-number">01</span><span className="how-icon">✦</span></div><h3>Parlez à Clara</h3><p>Répondez à quelques questions simples sur votre situation et votre projet, sans jargon ni formulaire interminable.</p><span className="how-card-note">Quelques minutes suffisent</span></article>
            <article className="how-card how-card-highlight" data-reveal><div className="how-card-top"><span className="how-number">02</span><span className="how-icon">◒</span></div><h3>Comprenez votre profil</h3><p>Votre situation est analysée sur 10 axes, pour mettre en lumière vos points forts et les éléments à préparer.</p><span className="how-card-note">Une lecture claire, sans jargon</span></article>
            <article className="how-card how-card-final" data-reveal><div className="how-card-top"><span className="how-number">03</span><span className="how-icon">✓</span></div><h3>Avancez avec confiance</h3><p>Vous obtenez une prochaine étape concrète et, si votre projet est prêt, une attestation à partager.</p><span className="how-card-note">Données protégées · Sans engagement</span></article>
          </div>
        </div>
      </section>
      ...
      <section className="manifesto-section section-wrap" data-reveal><span className="manifesto-mark">“</span><p>Mieux vaut connaître son dossier avant que la banque ne le découvre.</p></section>

      <section className="cta-section" id="contact"><div className="cta-glow" /><div className="section-wrap cta-inner" data-reveal><span className="eyebrow">Votre financement commence avec Courtia</span><h2>Donnez un temps d&apos;avance<br /><em>à votre projet.</em></h2><p>Créez votre compte et découvrez votre profil en quelques minutes.</p><a className="button button-primary" href={COURTIA_APP_URL}>Commencer <span>↗</span></a><small>Aucun engagement · Données protégées · Parcours confidentiel</small></div></section>

      <footer className="footer"><div className="section-wrap footer-top"><button className="brand" onClick={() => scrollToId("top")} aria-label="Courtia — retour en haut"><img className="brand-logo" src="/courtia-logo.png" alt="Courtia" /></button><p>Courtia, le copilote de votre financement.</p><nav><a href="#particuliers">Pour vous</a><a href="#fonctionnalites">La plateforme</a><a href="/prets-immobiliers">Prêt immobilier</a><a href="/assurance-de-pret">Assurance de prêt</a><a href="/qui-sommes-nous">Qui sommes-nous ?</a><a href="/mentions-legales">Mentions légales</a></nav></div><div className="section-wrap footer-bottom"><span>© 2026 Courtia</span><span>RGPD · IA Act · Chiffrement</span><span className="footer-contact"><a href={"mailto:" + COURTIA_EMAIL}>{COURTIA_EMAIL}</a><i /><a href={COURTIA_TEL_LIEN}>{COURTIA_TEL_AFFICHE}</a></span></div></footer>
    </main>
  );
}

...
const tools = [
  ...
  { icon: "⌁", title: "Portail de partage sécurisé", text: "Un espace de partage maîtrisé pour échanger avec votre banque, votre agent ou votre courtier." },
...
const professionalRoles = [
  ...
  ["Courtier", "Accompagnez plus de dossiers avec des informations fiables dès le départ."],
];
...
export default function Home() {
  ...
  return (
    <main className="site-shell">
      ...
      <section className="light-section trust-section"><div className="stats-row"><div><strong>10</strong><span>axes d&apos;analyse</span></div><div><strong>&lt; 5 min</strong><span>pour votre score</span></div><div><strong>30 j</strong><span>validité attestation</span></div><div><strong>RGPD</strong><span>données protégées</span></div></div><div className="section-kicker">Confiance</div><h2>Conçu pour la <em>conformité</em></h2><div className="trust-grid"><article><span>◌</span><h3>RGPD</h3><p>Données hébergées en Europe, environnement sécurisé et transparent.</p></article><article><span>⌁</span><h3>ORIAS</h3><p>Obligations d&apos;automatisation des intermédiaires en opérations de banque.</p></article><article><span>◇</span><h3>IA Act</h3><p>Transparence algorithmique, explicabilité des scores, supervision humaine.</p></article><article><span>▣</span><h3>SSL / Chiffrement</h3><p>Communications chiffrées de bout en bout, accès sécurisés et traçabilité.</p></article></div></section>

...
const personalAppUrl = "https://courtia-5bdr4aaus-courtia1.vercel.app/";
  ...
  return (
    <main className="site-shell">
      <header className="topbar">
        ...
        <a className="nav-login" href={personalAppUrl}>Se connecter</a>
        ...
        <div className="hero-inner">
          <div className="hero-copy" data-reveal>
            ...
            <div className="hero-actions">
              <a className="button button-primary" href={personalAppUrl}>Créer mon espace <span>↗</span></a>
      ...
      <section className="cta-section" id="contact"><div className="cta-glow" /><div className="section-wrap cta-inner" data-reveal><span className="eyebrow">Avant la banque, il y a Courtia</span><h2>Donnez un temps d&apos;avance<br /><em>à votre projet.</em></h2><p>Créez votre compte et découvrez votre profil en quelques minutes.</p><a className="button button-primary" href={personalAppUrl}>Créer mon espace Courtia <span>↗</span></a><small>Aucun engagement · Données protégées · Parcours confidentiel</small></div></section>
